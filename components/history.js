     ...
     <div style={styles.mainContainer}>
        ...
        <div style={styles.mainSubContainer} >
            <div style={styles.contentHolder}>
                ...
                <div style={styles.button}>Start Declaration</div>
        ...
        <div style={styles.mainSubContainer}>
            <div style={styles.contentHolder}>
                ...
                <p style={{ fontSize: '17px' }}>Use this form to declare potential or actual conflict of interest</p>
                <div style={styles.button}>Start Declaration</div>
        ...
        <div style={styles.mainSubContainer}>
            <div style={styles.contentHolder}>
                <h1 style={{fontWeight: 'bold'}}>Confirm training policy</h1>
                <p style={{ fontSize: '17px' }} >Use this form to declare gifts received in accordance with company policy</p>
                <div style={styles.button}>Start Declaration</div>
